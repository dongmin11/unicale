  ...
  <div class="addMember">
    <form action="{{route('addMember')}}" method="post">
      ...
      <table class="memberIndex">
        ...
        <tr>
          <td><input name="fullName" typstyle="width:50%;" e="text" value=""></td>
          <td><input name="memName" style="width:50%;" type="text" value="" style=></td>
          <td><input name="memName_2" style="width:50%;" type="text" value=""></td>
          <td>
            <select  style="padding:5px; color:white;" name="color" id="addColor">
            <option  value=""></option>
              @foreach($colors as $color)
